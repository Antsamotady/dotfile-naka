...
export ZSH="/home/hasintsilavina/.oh-my-zsh"
...
# Ataovy "random" fotsiny raha tsy misy tiana
# .oh-my-zsh/themes/
...
# There is a quick and easy way to set up a colored prompt in Zsh. Make sure that prompt theme system is set to autoload 
autoload -Uz promptinit
promptinit



# Node Version Manager: Related to the installation of nodejs, so ...
...
# Must have Add power to your terminal with powerline

#if [ -f `which powerline-daemon` ]; then
  #powerline-daemon -q
  #POWERLINE_BASH_CONTINUATION=1
 # POWERLINE_BASH_SELECT=1
#  . /usr/local/share/powerline.sh
#fi
